...
import java.lang.reflect.Field;
        ...
        import com.khantilchoksi.arztdoctor.data.*;
...
/* Class reference to help load the constructor on runtime *//*
    ...
    private final Class mDbHelperClass = AppointmentsDBHelper.class;
...
/* If this fails, it means that your database doesn't contain the expected table(s) *//*
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                AppointmentsContract.AppointmentsEntry.TABLE_NAME, tableNameCursor.getString(0));
...
/* Use WaitlistDbHelper to get access to a writable database *//*
        ...
        testValues.put(AppointmentsContract.AppointmentsEntry.COLUMN_GUEST_NAME, "test name");
        testValues.put(AppointmentsContract.AppointmentsEntry.COLUMN_PARTY_SIZE, 99);
