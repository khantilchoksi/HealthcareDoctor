...
public class GetPastAppointmentsOfDoctorClinicTask extends AsyncTask<Void, Void, Boolean> {

    private static final String LOG_TAG = GetPastAppointmentsOfDoctorClinicTask.class.getSimpleName();
    Context context;
    Activity activity;
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            final String CLIENT_BASE_URL = context.getResources().getString(R.string.base_url).concat("getPastAppointmentsOfDoctorClinics");
